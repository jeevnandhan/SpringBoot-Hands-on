--ALTER TABLE CATEGORY ADD CONSTRAINT customer_name_unq UNIQUE (category_Name);
...
INSERT INTO USER_INFO(USERNAME, PASSWORD) VALUES('jack', '$2a$12$GUnuf607kwtNBEO4.roxKOKeU4el9tOpHyGFSoosZW/oUVZZOwbri');
INSERT INTO USER_INFO(USERNAME, PASSWORD) VALUES('bob', '$2a$12$GUnuf607kwtNBEO4.roxKOKeU4el9tOpHyGFSoosZW/oUVZZOwbri');
INSERT INTO USER_INFO(USERNAME, PASSWORD) VALUES('apple', '$2a$12$GUnuf607kwtNBEO4.roxKOKeU4el9tOpHyGFSoosZW/oUVZZOwbri');
INSERT INTO USER_INFO(USERNAME, PASSWORD) VALUES('glaxo', '$2a$12$GUnuf607kwtNBEO4.roxKOKeU4el9tOpHyGFSoosZW/oUVZZOwbri');
